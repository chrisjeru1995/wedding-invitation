...
(function () {
  ...
  /* ---------- 3. Ambient fireflies + hearts (rich, on every screen) ----------
     Desktop: fixed canvas over the viewport.
     Mobile: NO fixed layers (they jitter on this device). The canvas + hearts
     span the whole document and scroll with the content, so the ambience is on
     every screen with zero shake. */
  ...
  function initFireflies() {
    ...
    const count = (mobile ? 20 : 55) * screens;
